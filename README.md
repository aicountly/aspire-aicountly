...
Aspire for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://aspire.aicountly.com | https://aspire.aicountly.com/api |
| Sandbox | https://aspire.gh.aicountly.com | https://aspire.gh.aicountly.com/api |
...
(`https://aspire.gh.aicountly.com/api`) so the token exchange has somewhere to

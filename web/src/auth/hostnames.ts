 ...
 * aspire.aicountly.com and aspire.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'aspire').trim() || 'aspire'
...
/**
 * `aspire.aicountly.com` and `aspire.gh.aicountly.com` both resolve to
 * `aspire`, which is what the portal expects in authentication_jump.
 */
